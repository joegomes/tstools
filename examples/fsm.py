...
from tstools.calc import QChemRunner, XTBRunner, TMDRunner 
from tstools.cos import FreezingString
from tstools.opt import CartesianOptimizer, InternalsOptimizer
from tstools.utils import load_xyz
...
def fsm(reaction_dir, optcoords='cart', interp='lst', 
    ...
    elif calculator == "tmd" or calculator == "tmd_ft":
        calc = TMDRunner(reactant, chg, mult, nt)
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--calculator", type=str, help="energy/force method", default='qchem', choices=['qchem', 'xtb', 'tmd', 'tmd_ft'])
